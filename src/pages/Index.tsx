...
const Index = () => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-gradient-to-br from-gray-50 to-blue-50/30 relative">
      {/* SidebarProvider ONLY wraps the sidebar, NOT the entire flex layout */}
      <SidebarProvider>
        <AppSidebar />
      </SidebarProvider>
      ...
      <main className="flex-1 flex flex-col items-stretch xl:px-8 px-4 pt-6 bg-transparent">
        ...
        <div className="flex items-center gap-4 mb-6">
          {/* SidebarTrigger is now OUTSIDE the provider and will open the sidebar */}
          <SidebarTrigger />
